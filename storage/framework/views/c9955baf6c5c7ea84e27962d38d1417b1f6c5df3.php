    ...
    <div class="w3layouts-main">
        ...
        ?>
            <form action="<?php echo e(URL::to('/admin-dashboard')); ?>" method="post">
                ...
                <input type="text" class="ggg" name="admin_email" placeholder="Tài Khoản" required=""   required oninvalid="this.setCustomValidity('Vui lòng điền vào các trường bắt buộc!')" onchange="this.setCustomValidity('')">
            ...
            <p>Chưa có tài khoản<a href="<?php echo e(URL::to('/validation-dashboard')); ?>">Tạo tài khoản mới!</a></p>
    </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\luanvan\resources\views/admin_login.blade.php ENDPATH**/ ?>
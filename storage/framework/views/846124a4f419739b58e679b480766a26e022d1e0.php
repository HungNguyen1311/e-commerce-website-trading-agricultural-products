    ...
    <div class="container-fluid">
        <div class="row danhmuc-row m-auto">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body menu-danhmuc">
                                ...
                                <p><a
                                        href="<?php echo e(URL::to('/danhmucsanpham/'.$cate_pro->idtheloai)); ?>"><?php echo e($cate_pro->tentheloai); ?></a>
                                </p>
            ...
            <div class="col-sm-9 danhmuc-hienthi">
                <h4 id="danhmuc-content">Sản Phẩm Khuyến Mãi</h4>
                <!-- SAN PHAM MOI  -->
                <div class="spm">
                    <div class="container-fluid">
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/pages/category/show_promotion.blade.php ENDPATH**/ ?>
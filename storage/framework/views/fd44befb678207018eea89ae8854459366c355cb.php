...
<div class="login-body">
        ...
        <div class="login">
            ...
            ?>
                <form action="<?php echo e(URL::to('/login-account')); ?>" method="POST">
                    ...
                    <div class="login-footer">
                        ...
                        <p><a href="<?php echo e(URL::to('/validation')); ?>">Đăng ký tài khoản mới!</a></p>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('product_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/pages/checkout/login_checkout.blade.php ENDPATH**/ ?>
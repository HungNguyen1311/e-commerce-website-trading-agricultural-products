        ...
        <div class="container-fluid">
            <div class="row danhmuc-row m-auto">
                ...
                <div class="col-sm-9 danhmuc-hienthi">
                    ...
                    <h4 id="danhmuc-content">{{$name_cate->tentheloai}}</h4>
                    @endforeach
                    <div class="sort-menu">
                        <div class="dropdown sort-menu-dropdown">
                            ...
                            <li><a class="dropdown-item" href="{{URL::to('/danhmucsanpham/'.$name_cate->idtheloai.'/sort_by=price-asc')}}">Giá: Tăng dần</a></li>
                                <li><a class="dropdown-item" href="{{URL::to('/danhmucsanpham/'.$name_cate->idtheloai.'/sort_by=price-desc')}}">Giá: Giảm dần</a></li>
                                <li><a class="dropdown-item" href="{{URL::to('/danhmucsanpham/'.$name_cate->idtheloai.'/sort_by=name-az')}}">Tên: A-Z</a></li>
                                <li><a class="dropdown-item" href="{{URL::to('/danhmucsanpham/'.$name_cate->idtheloai.'/sort_by=name-za')}}">Tên: Z-A</a></li>
                                <li><a class="dropdown-item" href="{{URL::to('/danhmucsanpham/'.$name_cate->idtheloai.'/sort_by=new-product')}}">Mới nhất</a></li>
                                <li><a class="dropdown-item" href="{{URL::to('/danhmucsanpham/'.$name_cate->idtheloai.'/sort_by=most-selling')}}">Bán chạy nhất</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- SAN PHAM MOI  -->

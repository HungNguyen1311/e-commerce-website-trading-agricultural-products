      ...
      <?php
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$all_product_order->tennhanvien}}</td>
            <td>
              <a href="{{URL::to('/show-order-product/'.$all_product_order->iddonhang)}}" class="active styling-edit" ui-toggle-class=""><i class="fa-solid fa-magnifying-glass"></i></a>

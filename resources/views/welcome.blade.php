...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">         
            ...
            ?>
            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="{{$key}}"aria-label="{{$key+1}}"></button>
            <?php
            }
            ?>
            @endforeach    
        ...
        @foreach($get_banner_image as $k => $get_banner_image)
        <?php
        if($k==0){       
        ?>
        <div class="carousel-item active">
            <img src="{{URL::to($get_banner_image->hinhanh)}}" class="d-block w-100" alt="...">
        </div>
        <?php
        }else{    
        ?>
    ...
    <div class="banner-content-danhmuc">
        <section id="sm-banner-danhmuc" class="section-p1">
            <div class="banner-box">
                <h2>Nông Sản Củ</h2>              
               <a href="{{URL::to('/danhmucsanpham/1')}}"><button class="btn btn-outline-light">Xem Thêm</button></a>
            </div>
            <div class="banner-box banner-box2">
                <h2>Nông Sản Lá</h2>               
                <a href="{{URL::to('/danhmucsanpham/2')}}"><button class="btn btn-outline-light">Xem Thêm</button></a>
            </div>
            <div class="banner-box banner-box3">
                <h2>Nông Sản Gia Vị</h2>           
                <a href="{{URL::to('/danhmucsanpham/4')}}"><button class="btn btn-outline-light">Xem Thêm</button></a>
            </div>
            <div class="banner-box banner-box4">
                <h2>Nông Sản Quả</h2>           
                <a href="{{URL::to('/danhmucsanpham/3')}}"><button class="btn btn-outline-light">Xem Thêm</button></a>
            </div>
        </section>
    </div>
    @yield('content')
